...
public class SettingView {
    ...
    private void updatePersonalInfo(String userId) {
        ...
        case Constants.UPDATE_NAME:
            ...
            userController.updateName(userId, name);
            break;
        ...
        case Constants.UPDATE_GENDER:
            ...
            userController.updateGender(userId, gender);
            break;

        case Constants.UPDATE_DOB:
            System.out.print("Enter DOB : ");
            String dateOfBirth = scanner.next();
            userController.updateDateOfBirth(userId, dateOfBirth);
            break;

        case Constants.UPDATE_PHONENUMBER:
            System.out.print("Enter Phone number : ");
            String phoneNumber = scanner.next();
            userController.updatePhoneNumber(userId, phoneNumber);
            break;
